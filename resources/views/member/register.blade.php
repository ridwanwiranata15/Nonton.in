            ...
            <div class="pt-[30px] relative">
                ...
                <div class=" flex flex-row justify-center items-center">
                    <a href="/index.html" class="block">
                        <img src="{{ asset('/assets/images/stream.svg') }}" alt="stream" />
                    </a>
                </div>
                ...
                <div class="pt-[85px] flex flex-col items-center gap-5 px-3">
                    ...
                    <section class="w-11/12 max-w-[460px]">
                        <form action="/storeregister" class="mt-[70px] flex flex-col bg-white p-[30px] rounded-2xl gap-6" method="post">
                            @csrf
                            ...
                            @enderror
                            <div class="form-input flex flex-col gap-3">
                                <label for="password" class="text-base font-medium text-stream-dark">Phone number</label>
                                <input type="text"
                                    class="rounded-full py-3 pr-3 pl-6 text-stream-dark placeholder:text-stream-gray placeholder:font-normal font-medium outline-stream-gray outline outline-1 text-base focus:outline-indigo-600 input-stream"
                                    placeholder="Your phone number"  name="phone_number" value="{{ old('phone_number') }}">
                            </div>
                            @error('phone_number')
                                <div class="" style="color: red">
                                    {{ $message }}
