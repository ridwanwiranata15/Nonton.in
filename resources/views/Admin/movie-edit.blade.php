        ...
        <form enctype="multipart/form-data" method="POST" action="{{ route('admin.movie.update', $movie->id) }}">
          ...
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="short-about" name="cast" placeholder="Jackie Chan" value="{{ $movie->cast }}">
            </div>
            <div class="form-group">
              <label for="short-about">Categories</label>
              <input type="text" class="form-control" id="short-about" name="category" placeholder="Action, Fantasy" value="{{ $movie->category }}">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <select class="custom-select" name="featured">
                <option value="0" {{ $movie->featured == '1' ? 'selected' : "" }}>No</option>
                <option value="1" {{ $movie->featured == '0' ? 'selected' : ""}}>Yes</option>
              </select>
            </div>
          </div>
          <!-- /.card-body -->
